...
class DAT_CNN(nn.Module):
    ...
    def forward(self, input, alpha=1):
        ...
        location_embeddings = F.gelu(self.fc_embedding_location(reverse_feature))
        location_embeddings_inference_only_embedding = F.gelu(self.fc_embedding_location(x))
        # -------------------------------------------------------------------------------------------------------------
        ...
        return event, location, common_embeddings, location_embeddings_inference_only_embedding
